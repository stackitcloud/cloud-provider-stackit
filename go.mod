...
require (
	...
	github.com/stackitcloud/stackit-sdk-go/services/iaas v1.2.3
...
require (
	...
	github.com/stackitcloud/stackit-sdk-go/services/resourcemanager v0.18.1 // indirect
...
replace k8s.io/cloud-provider => github.com/stackitcloud/cloud-provider v0.31.7-ske-1
